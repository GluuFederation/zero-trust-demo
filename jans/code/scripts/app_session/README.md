...
The script generates audit report and creates record in DB. Also **jansData** field (in the JSON format), that contains summary info of session audit will be generated.  
