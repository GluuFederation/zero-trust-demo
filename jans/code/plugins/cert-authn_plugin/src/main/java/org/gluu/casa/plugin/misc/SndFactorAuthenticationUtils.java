...
public interface SndFactorAuthenticationUtils {
     ...
     */
   default public Pair<CredentialRemovalConflict, String> removalConflict(String credentialType, int nCredsOfType, User user){
    	Pair<CredentialRemovalConflict, String> pair = new Pair<>(null,"null");
    	return pair;
    };
