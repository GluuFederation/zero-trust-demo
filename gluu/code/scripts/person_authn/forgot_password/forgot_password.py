...
class PersonAuthentication(PersonAuthenticationType):
    ...
    def init(self, customScript, configurationAttributes):
        ...
        if not (configurationAttributes.containsKey("attributes_json_file_path")):
            # print "Forgot Password - Initialization. Property attributes_json_file_path is mandatory"
            return False
    ...
    def authenticate(self, configurationAttributes, requestParameters, step):
        ...
        print "Forgot Password - %s - Authenticate for step %s" % (self.sf, step)
        ...
        if step == 3:
            ...
            new_password = ServerUtil.getFirstValue(requestParameters, "new-password")
    ...
    def prepareForStep(self, configurationAttributes, requestParameters, step):
        ...
        if step == 1:
            print "Forgot Password - Prepare for Step 1"
            print "Forgot Password - Prepare for Step 1. True"

            return True

        elif step == 2:
            print "Forgot Password - Prepare for Step 2"
            print "Forgot Password - Prepare for Step 2. True"

            return True

        elif step == 3:
            print "Forgot Password - Prepare for Step 3"
            ...
            identity.setWorkingParameter("pass_strength", str(attributes["pass_strength"]))
            ...
            print "Forgot Password - Prepare for Step 3. True"
    ...
    def getAttributes(self):
        ...
        attribs = {"pass_strength":strength,"pass_regex":pass_regex,"mail_regex":mail_regex}
        return attribs
