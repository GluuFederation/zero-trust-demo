...
class PersonAuthentication(PersonAuthenticationType):
    ...
    def init(self, configurationAttributes):
        print "Cert (Casa). Initialization"
        return True

    def destroy(self, configurationAttributes):
        print "Cert (Casa). Destroy"
        return True
    ...
    def authenticate(self, configurationAttributes, requestParameters, step):
        print "Cert (Casa). Authenticate for step %d" % step
        ...
        if step == 1:
            ...
            try:
                ...
                if cookie == None:
                    print "Cert (Casa). Expected cookie not found"
                else:
                    ...
                    if cookie["key"] != key:
                        print "Cert (Casa). Inconsistent cookie value"
                    else:
                        ...
                        print "Cert (Casa). Authentication result was %s" % result
                ...
                print "Cert (Casa). Exception: ", sys.exc_info()[1]

        return False


    def prepareForStep(self, configurationAttributes, requestParameters, step):
        print "Cert (Casa). Prepare for step %d" % step
        if step == 2:
            authenticationService = CdiUtil.bean(AuthenticationService)
